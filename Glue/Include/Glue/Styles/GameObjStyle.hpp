...
namespace Glue {
    ...
    public:
        ...
        GameObjStyle();
        GameObjStyle(std::string proto_name);
        ...
        void setPos(Scalar x, Scalar y, Scalar z);
        ...
        void setVel(Scalar xv, Scalar yv, Scalar zv);
        ...
        void setGravityType(GravityType gravityType);
        void setGravity(Scalar x, Scalar y, Scalar z);

        // 1 gives no damping and 0 is fully damped.
        Scalar linDamping;
        Scalar angDamping;
        void setDamping(Scalar lin, Scalar ang);
        ...
        Scalar ySize;
        Scalar zSize;
        void setSize(Scalar sz);
        void setSize(Scalar xSize, Scalar ySize, Scalar zSize);

        // Appearance properties
        SColor color;

        // Note:  This method puts alpha last as opposed to SColor which has it first.
        void setColor(IntColor r, IntColor g, IntColor b, IntColor a = 255);
        ...
        void setTextureFile(std::string value);
        ...
        Scalar axisZ;
        Scalar angle;
        void setAxis(Scalar x, Scalar y, Scalar z);
        ...
        Scalar linFactorY;
        Scalar linFactorZ;
        void setLinearFactor(Scalar x, Scalar y, Scalar z);

        // Angular factor lets you disable certain rotations of the object (useful for 2D game)
        Scalar angFactorX;
        Scalar angFactorY;
        Scalar angFactorZ;
        void setAngularFactor(Scalar x, Scalar y, Scalar z);
        ...
        Scalar physScaleY;
        Scalar physScaleZ;
        void setDispScale(Scalar x, Scalar y, Scalar z);
        void setPhysScale(Scalar x, Scalar y, Scalar z);
