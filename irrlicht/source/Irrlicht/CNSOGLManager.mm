...
{    
	...
	{
        NSOpenGLPixelFormatAttribute alphaSize = Params.WithAlphaChannel ? 4 : 0;
        NSOpenGLPixelFormatAttribute depthSize = Params.ZBufferBits;
        ...
        NSOpenGLPixelFormatAttribute Attribs[] =
        {
            ...
            NSOpenGLPFAStencilSize, Params.Stencilbuffer ? 1u : 0u,
